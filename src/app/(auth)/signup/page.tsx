  ...
  return (
    <div className="marketing-content flex min-h-[calc(100vh-65px)] items-center justify-center px-4">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        ...
        <div className="absolute -top-24 right-1/4 h-80 w-80 rounded-full bg-teal-500/10 blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md space-y-6">
        ...
        {sent ? (
          <div className="marketing-card rounded-xl p-8 text-center">
            ...
            <p className="mt-2 text-sm text-gray-400">
              We sent a magic link to your email. Click the link to get started.
            </p>
